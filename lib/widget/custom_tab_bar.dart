...
//   /// When a [CustomNavigationBarItem.prefixIcon] widget is not an [Icon] the widget
...
//             style: Theme.of(context).textTheme.title.copyWith(color: inactiveColor),
//             child: Padding(
