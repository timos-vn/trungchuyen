...
class ListHistoryTCBloc extends Bloc<HistoryTCEvent,ListHistoryTCState> {
  ...
  ListHistoryTCBloc(this.context)  {
    _networkFactory = NetWorkFactory(context);
  }

  // TODO: implement initialState
  ListHistoryTCState get initialState => ListHistoryTCInitial();

  @override
  Stream<ListHistoryTCState> mapEventToState(HistoryTCEvent event) async* {
    ...
    if(event is GetListHistoryTC){
      yield ListHistoryTCLoading();
